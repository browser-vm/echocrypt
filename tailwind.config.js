  ...
  theme: {
  	extend: {
  		...
  		colors: {
            ...
            'echocrypt-dark': 'rgb(23, 24, 28)',
            'echocrypt-light': 'rgb(250, 250, 250)',
            'echocrypt-primary': 'rgb(99, 102, 241)',
            // Shadcn UI colors
  		...
  		backgroundImage: {
            'grid-black': 'linear-gradient(-90deg, rgba(0,0,0,0.05) 1px, transparent 1px), linear-gradient(rgba(0,0,0,0.05) 1px, transparent 1px)',
            'grid-white': 'linear-gradient(-90deg, rgba(255,255,255,0.05) 1px, transparent 1px), linear-gradient(rgba(255,255,255,0.05) 1px, transparent 1px)',
